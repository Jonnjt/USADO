    ...
    <div class="main d-flex flex-column justify-content-center align-items-center">
        <div class="login-box p-5 shadow">
            <form action="" method="post">
                ...
                <div>
                    <button class="btn btn-success form-control mt-3 mb-2" type="submit" name="loginbtn">Login</button>
                </div>
                <div>
                    <small>Tidak punya akun? </small>
                    <a href="register.php" class= "a-btn">Register</a>  
                </div>
            </form>
        </div>
        <div class="mt-3" style=" width: 500px" >
            ...
            if (isset($_POST['loginbtn'])){
                ...
                $query = mysqli_query($con, "SELECT * FROM user_web WHERE email = '$email'");
